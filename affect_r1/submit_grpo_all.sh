...
# Training parameters
RUN_NAME="affect_r1_grpo2_all3_${PAPO_VERSION}"
...
torchrun --nproc_per_node $GPUS --nnodes $nodes --node_rank \$NODE_RANK --master_addr \$MASTER_ADDR --master_port \$MASTER_PORT \
    ...
    --report_to wandb \
    --scale_rewards false \
    --reward_funcs affect_reward.emotion_wheel_reward affect_reward.format_reward affect_reward.rubric_perc_reward_with_matrices affect_reward.rubric_coh_reward logit_reward.coherence\
    --reward_weights 1.0 0.1 0.5 0.5 0.2 \
