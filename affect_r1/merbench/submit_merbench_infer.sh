...
MODEL_PATH=/mnt/afs/hanzhiyuan/code/HumanOmniV2/affect_r1/output2/affect_r1_grpo_logit9
PROCESSOR_PATH=$MODEL_PATH
DATASET_ROOT=/mnt/afs/hanzhiyuan/datasets
OUTPUT_ROOT=/mnt/afs/hanzhiyuan/code/HumanOmniV2/affect_r1/output2/affect_r1_grpo_logit9/inference
...
# echo ">>> MERBench inference job will be submitted after 3 hours"
# echo "Command: ${COMMAND}"
# echo "Log file: ${LOG_FILE}"
# echo "Sleeping for 3 hours before submitting..."

# sleep 5h

echo ">>> Now submitting MERBench inference job"
sco acp jobs create \
