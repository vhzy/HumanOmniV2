#!/usr/bin/env python3
"""
根据track3_train_ovmerd_clues_Qwen.jsonl中的音频线索生成类似pope_audio.jsonl格式的问题
"""
import json
...
def generate_audio_questions(input_file, output_file, video_base_path="/mnt/afs/hanzhiyuan/datasets/mer2025/ovmerdplus-process/video"):
    """
    从包含音频线索的文件生成POPE格式的问题
    ...
    # 统计音频线索总数
    total_audio_cues = sum(len(item.get('audio_cues', [])) for item in input_data)
    print(f"音频线索总数: {total_audio_cues}\n")
...
if __name__ == "__main__":
    ...
    # 输出文件
    output_file = "/mnt/afs/hanzhiyuan/code/HumanOmniV2/affect_r1/data/pope_dataset/pope_audio_from_train.jsonl"
    
    # 生成问题
    results = generate_audio_questions(input_file, output_file)
